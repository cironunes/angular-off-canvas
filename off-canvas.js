...
(function () {
	...
	function cnOffCanvas(angular) {
		...
		angular.module('cn.offCanvas', [])
        	.factory('cnOffCanvas', cnOffCanvasFactory);

		cnOffCanvasFactory.$inject = ['$compile', '$rootScope', '$controller', '$http', '$templateCache', '$q'];

		function cnOffCanvasFactory ($compile, $rootScope, $controller, $http, $templateCache, $q) {
